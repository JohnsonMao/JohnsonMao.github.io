...
description: >-
  我們都知道 TypeScript 是 JavaScript 的超集，所以在介紹 TypeScript 的型別之前，我們先介紹一下 JavaScript
  原本就有的型別。
pubDate: '2024-09-03'
...
- `bigint`: ES2020 新出的型別，主要用來處理大數字
    ...
    const bigNumber: bigint = 66666666666666666666n
    ```
