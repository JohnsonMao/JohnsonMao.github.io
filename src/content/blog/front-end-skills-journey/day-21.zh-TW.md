---
series: front-end-skills-journey
...
console.log(Object.hasOwn(person, 'hasOwnProperty')) // false
```
...
console.log(Object.hasOwn(person.__proto__, 'hasOwnProperty')) // false
```
...
console.log(Object.hasOwn(person.__proto__.__proto__, 'hasOwnProperty')) // true
```
